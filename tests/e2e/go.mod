...
replace github.com/banzaicloud/koperator => ../../

replace github.com/banzaicloud/koperator/api => ../../api

replace github.com/banzaicloud/koperator/properties => ../../properties
